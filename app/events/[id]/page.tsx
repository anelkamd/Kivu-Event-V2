  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setEvent({
        ...
        status: "published",
        image: "/test.jfif",
        tags: ["technologie", "innovation", "numérique", "Presentation"],
        price: 20,
        venue: {
          id: "v1",
          name: "Grande Salle ISIG GOMA",
        ...
        agenda: [
          ...
          {
            id: "a5",
            title: "Presentation du Projet KIVU EVENT",
            description: "Présentation de Kivu Event : Pourquoi utiliser Kivu Event.",
