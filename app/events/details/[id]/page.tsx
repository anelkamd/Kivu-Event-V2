...
export default function EventDetailPage({ params }: { params: { id: string } }) {
    ...
    const handleDuplicateEvent = async () => {
        ...
        try {
            ...
            const response = await axios.post("/api/events", duplicatedEvent)
    ...
    return (
        <div className="container mx-auto py-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <p>{event.organizer?.name || "Non spécifié"}</p>
                                        </div>
                ...
                <TabsContent value="participants">{/* Contenu de l'onglet participants */}</TabsContent>

                <TabsContent value="check-in">{/* Contenu de l'onglet check-in */}</TabsContent>

                <TabsContent value="stats">{/* Contenu de l'onglet statistiques */}</TabsContent>
            </Tabs>
        </div>
    )
}
