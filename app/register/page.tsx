...
export default function Register() {
  const { register: registerUser, loginWithGoogle, loading: authLoading, error: authError } = useAuth()
              ...
              <form className="p-6 md:p-8" onSubmit={handleSubmit(onSubmit)}>
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-balance text-muted-foreground">Rejoignez Kivu Event pour gérer vos événements</p>
                  </div>
              ...
              <div className="relative hidden bg-muted md:block">
                ...
                <div className="absolute bottom-6 left-6 right-6 text-white">
                  ...
                  <p className="text-white/80">
                    Créez votre compte et commencez à organiser des événements inoubliables
                  </p>
                </div>
              </div>
            </CardContent>
